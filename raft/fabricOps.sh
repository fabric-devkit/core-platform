...
export COMPOSE_PROJECT_NAME=raft
export CA_IMAGE_TAG=1.4.1
export PEER_IMAGE_TAG=1.4.1
export ORDERER_IMAGE_TAG=1.4.2
export FABRIC_TOOL_IMAGE_TAG=1.4.4
...
function network(){
    ...
    case $subcmd in
        "start")
            docker-compose -f ./docker-compose-orderers.yaml -f ./docker-compose-peers.yaml up -d
            ;;
        "stop")
